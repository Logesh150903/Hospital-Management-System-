...
<body>
    <header>
        ...
        <a href = "newpatient.html"><button class="btnLogin-popup">Back</button></a>
        <nav class="navigtion">
    ...
    <div class="container">
        ...
        <form action="process_prescription1.php" method="post">
<?php
// Database connection
...
$sql = "INSERT INTO patients (patient_name, age, gender, symptoms, diagnosis,doctor_name) VALUES ('$name', '$age', '$gender', '$symptoms', '$diagnosis','$doctor_name')";
